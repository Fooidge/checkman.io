...
angular.module("JC-templates", []).run(["$templateCache", function($templateCache) {$templateCache.put("pages/main.html","<div class=\"heroPage u-maxXY u-flex u-centerXY\"><svg class=\"heroPage-logo\"><use xlink:href=\"#icon-logo\"></use></svg></div>");
