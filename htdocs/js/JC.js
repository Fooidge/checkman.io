...
angular.module('JC').directive('animatedBackground', function() {
  return {
    ...
    controller: ["$window", "$element", "jmath", function($window, $element, jmath) {
      var Particle, _MAX_PARTICLES, _PARTICLE_DECAY_RATE, _animate, _canvas, _changeGravity, _clearCanvas, _clearParticle, _context, _screenCenter, _screenHeight, _screenWidth, i, j, mousePosition, part, particles, ref, resizeCanvas;
      _MAX_PARTICLES = 150;
